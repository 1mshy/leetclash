 ...
 * last verdict — never the opponent's code. Fed by `progress` match events
 * and the state snapshot on (re)join, via the Zustand match store.
 */
